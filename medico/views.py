...
def abrir_horario(request): 
    ...
    if request.method == "GET":
        ...
        if data_formatada <= datetime.now():
            messages.add_message(request, constants.WARNING, 'A data não pode ser anteriror a data atual, escolha outra data.')
            return redirect('/medicos/abrir_horario')
    ...
    messages.add_message(request, constants.SUCCESS, 'Horario cadastrados com sucesso!')
    return redirect('/medicos/abrir_horario')
